adminApp.controller('statisticsMain.controller', ['$scope','statisticFactory', function ($scope,statisticFactory) {
    console.log('in statisticsMain.controller');
    ...
    statisticFactory.getVisit({},function (result) {
        ...
        if (result.code == '200') {
            ...
            var test = new stackLine(document.getElementById('test'),data,xdata.reverse(),title,false);
