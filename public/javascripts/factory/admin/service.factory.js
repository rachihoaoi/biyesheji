adminApp.factory("serviceFactory", ['$http', function ($http) {
    var service = {};
    ...
    service.update = function (params, callback) {
        angularHttpPost($http, "/HospitalServicePlatform/api/service/update", params, function (response) {
            callback(response);
        })
    };
